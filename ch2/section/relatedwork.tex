...
%approaches. There are some papers focusing on the information diffusion across topics and time on Twitter, such as
...
%In our paper, we also applied SIS model for news and rumor spreading over Twitter.
...
%have to be more tightly linked. Look at some of my papers to get
%an idea. You don't need 1 sentence for each paper. You can group papers
%further and cite them together. For instance: Some papers [CITE1, CITE2]
...
%in this paper. Replace 'Real' by 'Type' so that the types are
